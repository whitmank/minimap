...
var index = require('./index-031745f2.cjs.prod.js');
var inherits = require('./inherits-0aed8599.cjs.prod.js');
    ...
    value: function unregisterNodeProgram(key) {
      if (this.nodePrograms[key]) {
        var _this$nodePrograms = this.nodePrograms,
          ...
          programs = _objectWithoutProperties(_this$nodePrograms, [key].map(inherits.toPropertyKey));
        program.kill();
      ...
      if (this.nodeHoverPrograms[key]) {
        var _this$nodeHoverProgra = this.nodeHoverPrograms,
          ...
          _programs = _objectWithoutProperties(_this$nodeHoverProgra, [key].map(inherits.toPropertyKey));
        _program.kill();
    ...
    value: function unregisterEdgeProgram(key) {
      if (this.edgePrograms[key]) {
        var _this$edgePrograms = this.edgePrograms,
          ...
          programs = _objectWithoutProperties(_this$edgePrograms, [key].map(inherits.toPropertyKey));
        program.kill();
